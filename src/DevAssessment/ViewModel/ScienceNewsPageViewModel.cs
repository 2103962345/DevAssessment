...
{
    public class ScienceNewsPageViewModel : BindableBase
    {
        ...
        public ScienceNewsPageViewModel(INewsService newsService, IDialogService dialogService, IConnectivity connectivity)
        {
        ...
        private async void LoadNewsList()
        {
            try
            {
                ...
                TopHeadlines latestNews = await _newsService.GetTopNewsByCategory("us", "science", "f7cb4296dd7b4311b6c5e099345c71ab");
